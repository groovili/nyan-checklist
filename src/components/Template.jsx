...
class Template extends React.Component
{
  render() {
    ...
    for (var [key, value] of tasksList.entries()) {
      ...
      <span className="label label-info label-time"><FontAwesomeIcon icon="hourglass-half"/>&nbsp;{duration.asHours()}</span>
            ...
            <div className="panel-heading">
              <div className="row">
                <div className="col-lg-6 col-md-6 col-sm-6">
                  ...
                  <span className={css(appStyles.dividerSmall)}></span>
                  <span className="label label-warning"><FontAwesomeIcon  icon="hourglass-half"/>&nbsp;{totalEstimatedCurrent.asHours()} hours</span>
                </div>
                <div className="col-lg-6 col-md-6 col-sm-6">
